...
#HOME INFORMATION
#===============================================
pd_source_dir = "/storage/home/hhive1/jbrandt35/data/GalaxiesResearch/Packages/powderday"
...
zoom_box_len = 10 # kpc; so the box will be +/- zoom_box_len from the center
...
#DUST INFORMATION 
#===============================================
dustdir = '/storage/home/hhive1/ssethuram6/data/Work/hyperion-dust-0.1.0/dust_files/' #location of your dust files
...
metallicity_legend= "/storage/home/hhive1/ssethuram6/data/pd/fsps/ISOCHRONES/Padova/Padova2007/zlegend.dat"
...
NPHI = 3
SED = True
#Why can I get more theta,phi beyond 3?
...
IMAGING = True
filterdir = "/storage/home/hhive1/jbrandt35/data/GalaxiesResearch/Packages/powderday/filters/"
filterfiles = [
    #'arbitrary.filter',
    'JWST_test_10.filter'
#'B_subaru.filter',
